...
\item[$\bullet$]Automatisierung von Gebäudefunktionen wie Heizung, Licht und Jalousiestellung
...
Um dies zu implementieren, muss das Zielpunktobjekt angepasst werden. Standortobjekte benötigen neben Namen und Positionen noch eine iBeacon ID, sowie Major- und Minor-Werte. 
...
Hierfür navigiert man in der Console zum Hauptordner der App. Dort führt man folgenden Befehl aus:
...
Draufhin erfolgt die automatische Installation im Ordner "plugin" der App und es kann auf die Schnittstellen zugegriffen werden.
