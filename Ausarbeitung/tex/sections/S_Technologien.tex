...
\begin{tabular}{|p{3.5cm}|p{3.5cm} p{3.5cm} p{3.5cm}|} 
	\hline
		...
		\rowcolor[gray]{.75}  Zugriff auf Hardware & Schlecht, nur auf wenige Hardware Komponenten kann zugegriffen werden & Voller, Zugriff auf gesamte Hardware möglich & \\ 
		\rowcolor[gray]{.9} Vorraussetzungen und Vorkentnisse & durch, die Vorlesung "Web Engineering" sind ausreichend Kentnisse, vorhanden & Kentinnes,für Android Programmierung durch Java vorhanden. Kentnisse über iOS,programmierung nicht vorhanden & Hybrid,App wird mit Web Technologien programmiert, welche vorhanden sind. \\ 
