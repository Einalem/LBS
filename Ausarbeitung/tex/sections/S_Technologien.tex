...
\begin{tabular}{|p{3.5cm}|p{3.5cm} p{3.5cm} p{3.5cm}|} 
	\hline
		...
		\rowcolor[gray]{.75}  Zugriff auf Hardware & Schlecht, nur auf wenige Hardware Komponenten kann zugegriffen werden & Voller Zugriff auf gesamte Hardware möglich & Zugriff auf Hardware durch Framework und externe Plug-Ins möglich\\ 
