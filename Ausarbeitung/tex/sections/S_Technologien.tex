...
Aus den Anforderungen heraus wurde sich im Rahmen dieser Arbeit für diverse Technologien entschieden, welche eine Umsetzung der Anforderungen ermöglichen.
...
Marktanteile besitzen. TODO hier Diagramm Marktanteil Es handelt sich um folgende Betriebssysteme: 
\begin{description}
  \item[$\bullet$] Android
  \item[$\bullet$] iOS
  \item[$\bullet$] Windows
...
Implementierung des Programm als native App. Bei einer App handelt es sich um ein 
Programm welches speziell für ein mobiles Betriebssystem entwickelt wurde.

Implementierung als HybridApp
Eine HybridApp ermöglicht es mit einem Quellcode mehrere App's erstellen zu lassen. 
Zur Verwendung kommen WebTechnologien

Diese drei Möglichkeiten sollen im folgenden Abschnitt anhand von definierten 
Kriterien bewertet werden.


Folgende Kriterien wurden für die Auswahl einer Implentierungsmethode betrachtet:
\begin{enumerate}
\item Zugriff auf Hardware des mobil Telefons
...
\item Voraussetzungen und Vorkenntnisse
Da diese Studienarbeit innerhalb von (?) Monaten entstanden ist und andere Projekte 
...
Browser ausgeführt wird. Eine für Smartphones optimierte WebApp fokusiert sich 
...
die Entwicklung einer LBS- WebApp gering. Auf die Plattformunabhängigkeit stellt 
für eine WebApp keine Schwierigkeiten dar, da die genannten Web Technologien 
standartisiert sind. Allerdings fehlen definierte Schnittstellen für die Hardware 
...
Betriebssystem lauffähig sind. Eine Ausführung auf einem Computer oder anderem 
...
Gerät Testen, so wird ein Apple Developer Account sowie das IOS Developer Programm, 
...
Durch die Entscheidung für Cordova und Ionic ist die Verwendung von HTML5 vorgegeben. Um eine Hybride App über Cordova erstellen lassen zu können, müssen die Texte in HTML-Seiten beschrieben werden. Damit sie dann bei der Erstellung interpretiert werden können. In diesem Abschnitt wird die Technologie HTML im Allgemeinen und HTML5 im speziellen erläutert.
