...
\item Gute Dokumentation mit Codebeispielen\\
TODO:
Durch Wiki-Beiträge ist es nahezu immer möglich auch schwierige Aufgaben zu lösen.

\item Zukunftssicherheit\\
TODO:
Community + OpenStreetMap Foundation + Viele andere Karten basieren darauf
...
Dokumentation ist nicht so ausführlich wie bei Google- und Bing Maps


Die gewünschte funktionalen Anforderungen konnte nur Google Maps ohne zur Hilfenahme von externen Bibliotheken erfüllen. 

Bei den nichtfunktionalen ist nur Bing Maps negativ aufgefallen, da dort eine Registrierung mit unterschiedlichen Lizenzmodellen vorausgesetzt wird und die Anzahl der kostenlosen Abfragen im Vergleich zu Google Maps und Open Street Maps bescheiden ist.

Bei der Betrachtung der Vor und Nachteile liegt auch Google vorne.

Das Fazit ist, dass sich Google Maps am besten für den Einsatzzweck dieser Studienarbeit und der damit verbundenen Location-based Services App eignet, da alles aus einer Hand kommt, sowie eine ausführliche Dokumentation mit vielen Beispielen den Einstieg vereinfacht und die hohe Anzahl an kostenloser Abfragen für diese Studienarbeit mehr als ausreichen sollte.